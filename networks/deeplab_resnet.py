...
class MS_Deeplab(nn.Module):
    ...
    def forward(self,x):
        ...
        input_sizey = x.size()[1]
        self.interp1 = nn.UpsamplingBilinear2d(size = (  int(input_sizey*0.75)+1,  int(input_sizex*0.75)+1  ))
        self.interp2 = nn.UpsamplingBilinear2d(size = (  int(input_sizey*0.5)+1,   int(input_sizex*0.5)+1   ))
        self.interp3 = nn.UpsamplingBilinear2d(size = (  outS(input_sizey),   outS(input_sizex)   ))
        out = []
        x2 = self.interp1(x)
        x3 = self.interp2(x)
